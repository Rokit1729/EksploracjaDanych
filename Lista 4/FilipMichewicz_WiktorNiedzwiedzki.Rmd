...
kable(matrix, caption = "Macierz pomyłek - k-średnie") %>%
  add_header_above(c("Prawdziwa \n klasa" = 1, "Przewidywana klasa" = 6)) %>% 
  kable_styling(latex_options = c("striped", "hold_position", "repeat_header"), 
                repeat_header_text = "(kontynuacja)",
                stripe_color = "#B0B0B0")
...
Dokładność klasyfikacji uzyskana metodą AGNES z wykorzystaniem najdalszego sąsiada wynosi `r wynik_machen_4`%.
